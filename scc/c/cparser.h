...
#define c_type_parse_info_init() { dsc_auto, fct_auto, tq_unqualified, 0 }
#define c_type_iterator_info(ptree) ((struct c_type_parse_info*)tree_iterator_data(ptree))
